...
public class ClickSteps {
	...
	public void mouseHover_on_Menu_Link(String sControlName, String sPageName) throws Throwable {
		System.out.println("performing mousehover" + sControlName);
		Thread.sleep(5000);
		try {
	...
	public void i_select_tab_on_page(String sControlName, String sPageName) throws Exception {
		...
		System.out.println("Book menu is selected");
	}
	...
	public void i_select_from_1Adults_dropdown_on_page(String sControlName, String sPageName)
	...
	public void i_select_from_2Adults_dropdown_on_page(String sControlName, String sPageName)
			throws InterruptedException {
		Thread.sleep(5000);
	...
	public void i_select_from_Adults_dropdown_on_page(String sControlName, String sPageName)
			throws InterruptedException {
		Thread.sleep(5000);
